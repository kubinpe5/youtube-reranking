    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                ...
                <table class="times table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>Úkon</th>
                    ...
                    <tfoot>
                        <tr>
                            <th>Celkový čas</th>
                            <th>
                                <?php echo round( $allTimes, 3 ); ?>s</th>
                        </tr>
                    </tfoot>
                    <tbody>
            ...
            <table class="results table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="metadata">
                            <?php if ($toRerank) {echo $rankedMetastores[ $metastore->getOldRank() - 1 ];} else echo $rankedMetastores[ $metastore->getOldRank() ]; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
