...
if( isset( $_POST[ 'submit' ] ) ) {
	...
	usort( $rankedMetastores, function ( $a, $b ) {
		return $a->rerankResult < $b->rerankResult;
	} );
} else {
...
<form action="./" method="POST" class="inputs">
	...
	<fieldset class="rerankInformation">
		...
		<dl>
			...
			<dd>
				...
				<input class="publishedText" type="date" value="<?php echo $rerankInputs[ 'published' ]->getValue(); ?>" name="<?php echo PUBLISHED_VALUE; ?>" id="published_value">
			</dd>
			...
			<dd>
				...
				<input class="gpsText" type="text" value="<?php echo $rerankInputs[ 'gps' ]->getValue(); ?>" name="<?php echo GPS_VALUE; ?>" id="gps_value">
			</dd>
			...
			<dd>
				...
				<input class="viewsText" type="number" value="<?php echo $rerankInputs[ 'views' ]->getValue(); ?>" name="<?php echo VIEWS_VALUE; ?>" id="views_value" min="0">
			</dd>
		</dl>
	</fieldset>
	...
	<table class="results">
		...
		foreach( $metastores as &$metastore ) {
			...
			<tr>
				...
				<td class="metadata"><?php echo $metastore; ?></td>
				<td class="metadata"><?php echo $rankedMetastores[ $metastore->getOldRank() - 1 ]; ?></td>
			</tr>
			<?php
		}
		?>
